...
public class PanelResultado extends JPanel {
    ...
    private JButton mostrar, regresar, informacion;
    ...
    public PanelResultado() {
        ...
        mostrar.setBounds(230, 223, 140, 28);
        add(mostrar);
        ...
        informacion.setFont(new Font("Century Gothic", Font.BOLD, 13));
        informacion.setActionCommand("INFORMACION");
        informacion.setBackground(new Color(217, 237, 244));
        informacion.setBorderPainted(true);
        informacion.setFocusPainted(false);
        informacion.setBounds(429, 243, 130, 23);
        add(informacion);
